...
const SettingsPage = () => {
  ...
  const handlePaypalEmail = async (email: any) => {    
              ...
              <div>
                <div className="mt-1 flex items-center mb-3">
                  <input
                    ...
                    onChange={(e: any)=>{setEmailValid(checkValidEmail(e.target.value)), emailValid ? setEmailInput(e.target.value) : setEmailInput(null)}}
                  />
                </div>
          ...
          </div>
          {
            ...
            <div className="border-t-4 p-6 bg-white flex items-center justify-start">
              <Button
                ...
                primary
                disabled={loading}
                onClick={(e: any)=>{handlePaypalEmail(emailInput)}}
              >
